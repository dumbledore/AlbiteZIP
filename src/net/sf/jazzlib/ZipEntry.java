...
public class ZipEntry implements ZipConstants
{
  ...
  private ZipEntry(ZipEntry e)
  {
    ...
    if (e.extra != null) {
        /*
         * clone the `extra` field
         */
        extraNew = new byte[e.extra.length];
        System.arraycopy(e.extra, 0, extraNew, 0, extraNew.length);
    }
